              ...
              {group.requests.length === 0 ? (
                ...
                <ul className="divide-y overflow-hidden rounded-xl border">
                  {group.requests.map((req) => (
                    <li
                      key={req.id}
                      className="relative flex items-start gap-4 px-4 py-3.5 transition-colors hover:bg-muted/40"
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <Link
                          ...
                          className="font-medium break-words after:absolute after:inset-0 hover:underline focus-visible:underline focus-visible:outline-none"
                        >
                          {req.title}
                        </Link>
