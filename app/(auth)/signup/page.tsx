    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="mb-8">
          ...
          <p className="text-zinc-400 text-sm mt-1">Create your workspace</p>
        </div>
        ...
        <form action={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm text-zinc-300 mb-1.5">Organization name</label>
            <input
              name="orgName"
              type="text"
              required
          ...
          <div>
            <label className="block text-sm text-zinc-300 mb-1.5">Work email</label>
            <input
              name="email"
              type="email"
              required
