...
- [ ] **B2.** Migration 0012 — invite team scoping + unique pending invite index + pg-tap. (~1.25 hours)
- [ ] **B3.** Migration 0013 — `transfer_workspace_ownership` RPC + pg-tap. (~2 hours)
- [ ] **B4.** Migration 0014 — `profiles.left_at` + orphaned workspace admin view + pg-tap. (~1 hour)
